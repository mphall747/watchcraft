...
<head>
    ...
    <title>{{ config('app.name', 'Watchcraft') }}</title>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="/inventories/id/1">Burscough</a>
                                <a class="dropdown-item" href="/inventories/id/2">Ellesmere Port</a>
                                <a class="dropdown-item" href="/inventories/id/3">Workshop</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="/inventories/parts">Parts</a>
                                <a class="dropdown-item" href="/inventories/suppliers">Suppliers</a>
